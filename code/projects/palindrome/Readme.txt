...
in the Palindrome solution and folders 
...
code and project files in the Palindrome
solution for evaluation purposes only. 
For any other use, please obtain prior 
permission from the author and owner 
of the solution, Rasika Kavinda 
Wijayaratne (see above).

SOFTWARE USED
=============

The Palindrome solution was created using
